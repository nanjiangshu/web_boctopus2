...
g_params['MAX_DAYS_TO_SHOW'] = 10000
g_params['BIG_NUMBER']  = 100000
g_params['AVERAGE_RUNTIME_PER_SEQ_IN_SEC']  = 180
...
qd_fe_scriptfile = "%s/qd.py"%(path_app)
...
def oldtopcons(request):#{{{
    url_oldtopcons = "http://boctopus1.topcons.net"
